...
type RemoteWriteSpec struct {
	...
	URL string `json:"url"`
	// Timeout for requests to the remote read endpoint. (Defaults: 30s)
	RemoteTimeout *metav1.Duration `json:"remoteTimeout,omitempty"`
...
type PrometheusSpec struct {
	...
	// RemoteWrite spec to specify prometheus 2+ remote_read configuration.
	RemoteWrite *RemoteWriteSpec `json:"remoteWrite,omitempty"`
	// RemoteRead spec to specify prometheus 2+ remote_read configuration.
